...
namespace Sistran.Kernel.Domain.ValueObjects.Validation
{
    public static class AssertionConcern
    {
        public static DomainNotification AssertArgumentGreater(double valueReference, double valueCompare, string message)
        {
